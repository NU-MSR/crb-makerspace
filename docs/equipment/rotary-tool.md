...
!!! warning
    ...
    - High-speed rotating bits (5,000-35,000 RPM) can cause severe cuts
    - Flying debris and broken bits become projectiles
    - Bit can grab workpiece causing loss of control
    - Generates fine dust particles
    - Hot debris and workpieces after use can burn skin
...
## Use
- Select the correct bit/accessory for the material.
...
- Ask staff if you’re unsure about a material.

## Cleanup
- Power off and allow hot accessories to cool before handling.
- Return the tool, bits, and accessories to their proper locations.
- Vacuum debris and wipe down the workspace.